...
int main()
{
    ...
    int path = 0, pathForBridge = 0, pathToFinalLevel = 0, treasureCheast = 0;
    ...
    if (path == 1)
    {
        ...
        else if (pathForBridge == 2)
        {
            printf("Player found a bridge.\n");
            scanf("%d", &pathToFinalLevel);

            if (pathToFinalLevel == 1)
            {
                printf("Player crosses the bridge safely.\n");
            }

            else if (pathToFinalLevel == 2)
            {
    ...
    scanf("%d", &treasureCheast);

    if (treasureCheast == 1)
    {
        printf("All that glitters is not gold, Game Over!\n");
    }
    else if (treasureCheast == 2)
    {
        printf("All your efforts were for nothing, Game Over!\n");
    }
    else if (treasureCheast == 3)
    {
