...
int main()
{
    ...
    if (num % 2 == 0 && num > 15 && num % 3 == 0 && num % 7 == 0)
    {
        printf("The verdict for the number %d is: SUPERNATURAL", num);
    }

    else if ((num % 2 == 0 && num > 15 && num % 3 == 0) || (num > 15 && num % 3 == 0 && num % 7 == 0) || (num > 10 && num % 2 == 0 && num % 7 == 0))
    {
    ...
    else if (num <= -10 * 10 * 10 * 10 * 10 * 10 && num >= 10 * 10 * 10 * 10 * 10 * 10)
    {
